...
use crate::compression::zlib_store_span;
...
use crate::file_utils::{
    close_file_or_throw, embedded_filename_problem, has_file_extension, open_input_file,
...
pub fn conceal_data(
    ...
    if is_mastodon {
        ...
        let compressed_profile =
            store_mastodon_profile(&profile_vec, max_compressed_profile_size)?;
