use crate::common::{
    FileTypeCheck, MAX_COVER_IMAGE_SIZE, MAX_PROGRAM_FILE_SIZE, REDDIT_UPLOAD_SIZE_LIMIT,
};
...
fn validate_size_constraints(file_size: usize, file_type: FileTypeCheck) -> Result<()> {
    ...
    if file_type == FileTypeCheck::RedditCoverImage && file_size > REDDIT_UPLOAD_SIZE_LIMIT {
